...
\end{equation}
Under the assumption that the result of $XGBoost$ may serve as an estimator of the conditional distribution of $y$, we propose our ranking algorithm as follows: 
