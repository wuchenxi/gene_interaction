...
##        print ('type two, k = ' + str(k) + ' auc: ' + str(auc))
        sum_dauc += auc2 - auc1
      #  sum_sqdauc += (auc2 - auc1)**2
      #var_dauc=(sum_sqdauc-sum_dauc**2/10.0)/9.0
      #t_dauc=sum_dauc/(10.0*var_dauc)**0.5
      #print sum_dauc, sum_sqdauc, var_dauc, t_dauc
...
def model(filename):
  ...
  for n_samples in range(1000, 4000, 1000):
